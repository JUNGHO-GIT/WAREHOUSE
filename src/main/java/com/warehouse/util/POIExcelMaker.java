...
public class POIExcelMaker {
  ...
  public CellStyle textAlign(HSSFWorkbook xlsxWb, String align) {
    ...
    if (align == "left") cellStyle.setAlignment(HSSFCellStyle.ALIGN_LEFT); else if (
      align == "right"
    ) cellStyle.setAlignment(HSSFCellStyle.ALIGN_RIGHT); else cellStyle.setAlignment(
  ...
  public CellStyle borderTopBottom(HSSFWorkbook xlsxWb, String align) {
    ...
    if (align == "left") cellStyleBorder.setAlignment(HSSFCellStyle.ALIGN_LEFT); else if (
      align == "right"
    ) cellStyleBorder.setAlignment(HSSFCellStyle.ALIGN_RIGHT); else cellStyleBorder.setAlignment(
      HSSFCellStyle.ALIGN_CENTER
    );
  ...
  public CellStyle wrapLine(HSSFWorkbook xlsxWb, String align) {
    ...
    if (align == "left") cellStyle.setAlignment(HSSFCellStyle.ALIGN_LEFT); else if (
      align == "right"
    ) cellStyle.setAlignment(HSSFCellStyle.ALIGN_RIGHT); else if (
      align == "center"
    ) cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER); else cellStyle.setVerticalAlignment(
