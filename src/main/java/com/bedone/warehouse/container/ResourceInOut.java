...
public class ResourceInOut {
  ...
  private Date regDate, issueDate;
	...
	public ResourceInOut() {
		super();
	}

	public ResourceInOut (
    Integer inOutSeq,
    String inOutDt, String inOut,
    Integer resrcCd, String resrcNm,
    Integer qty,
    Double unitPrice, Double supplyPrice,
    String remark,
    Integer houseCd, Integer compCd,
    String houseNm, String compNm,
    String fileUrl,
    String flagYN, String planYN, String issueID,
