...
<!-------------------------------------------------------------------------------------------------><body class="body">
  <div class="container">
          ...
          <div class="row">
                    ...
                    <div class="d-row-left mr-10px">
                      <div class="form-control d-left">
                        ...
                        <div
                          ...
                          class="fs-0-7rem fw-600 light-black mr-auto"
                        ></div>
                        <div
                          id="fileUpBtn"
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="hidden-wrapper">
                <input type="hidden" id="resrcCd" name="resrcCd" value="" />
                <input type="hidden" id="tableNm" name="tableNm" value="tblResource" />
                <input type="hidden" id="tableKey" name="tableKey" value="0" />
                <input type="hidden" id="keyColumn" name="keyColumn" value="resrcCd" />
    ...
    <!-- js -->
    <script defer src="${rsPath}/scripts/page/resource.js"></script>
