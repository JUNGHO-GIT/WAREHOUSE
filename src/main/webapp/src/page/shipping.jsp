...
<!-------------------------------------------------------------------------------------------------><body class="body">
  <div class="container">
            ...
            <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
              <div class="d-row-left mr-10px">
                <input
                  ...
                  id="findStartDt"
                  name="findStartDt"
                  class="form-control form-control-sm pointer mr-10px"
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="hidden-wrapper">
                <input type="hidden" id="shipCd" name="shipCd" value="" />
              </div>
            </div>
          </div>
        </form>
    ...
    <!-- js -->
    <script defer src="${rsPath}/scripts/page/shipping.js"></script>
