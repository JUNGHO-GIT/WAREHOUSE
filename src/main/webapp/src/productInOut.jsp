  ...
  <div class="container px-20px">
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
        <div class="cards">
          <div id="grid02" class="cards-grid h-35"></div>
          <hr/>
            ...
            <form class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                  ...
                  onkeydown="fnFindProductCd(this.value, '', 'prodCd')" />
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                  <select id="prodCd" class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                  <input class="form-control" type="text" id="compNm" onkeydown="fnFindCompanyCd(this.value,'','compCd')" />
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              ...
              <div class="form-group">
                <label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label">메모</label>
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                  <textarea class="form-control resize-none" rows="2" id="remark"></textarea>
                </div>
              </div>
              <div class="form-group">
    ...
    <!-- js -->
    <script src="${rsPath}/scripts/pages/productInOut.js"></script>
