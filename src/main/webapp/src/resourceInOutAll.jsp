...
<body class="nav-md">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="cards" id="gridView">
          ...
          onClick="fnSwitchTab('in')">
          	<input type="radio" class="resrcInOutAll d-none" name="inOut" value="in" checked/>입고
          </button>
          <button type="button" class="btn btn-secondary cards-tab" id="outTab"
          onClick="fnSwitchTab('out')">
            <input type="radio" class="resrcInOutAll d-none" name="inOut" value="out" />출고
          </button>
  ...
  <script src="/inc/js/page/resourceInOutAll.js"></script>
</body>
