      ...
      <div class="x_content bs-example-popovers bg-white" id="popBody">
        <div class="row mt-10px">
          <div class="form-horizontal">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 mt-2px">
        ...
        <div class="row">
          <div class="cards-button">
            <button type="button" class="btn btn-primary btn-sm mr-10px" onclick="fnSaveAll()">
              저장
            </button>
            <button type="button" class="btn btn-danger btn-sm mr-10px" onclick="fnGridPopup('popupInOutAll','off')">
              닫기
            </button>
          </div>
        </div>
