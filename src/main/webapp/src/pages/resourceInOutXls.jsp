...
<body class="nav-md">
      ...
      <form class="form-horizontal m-0">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="row">
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 mt-5 d-center">
              <input type="file" name="resourceInOutXls" id="resourceInOutXls" accept=".xls, .xlsx" />
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 mt-3 d-center">
            ...
            <div class="col-lg-4 col-md-2 col-sm-2 col-xs-12 mt-5">&nbsp;</div>
  ...
  <script src="${rsPath}/scripts/json2Xls.js"></script>
  <script src="${rsPath}/scripts/pages/files.js"></script>
  <script src="${rsPath}/scripts/pages/resourceInOutXls.js"></script>
</body>
