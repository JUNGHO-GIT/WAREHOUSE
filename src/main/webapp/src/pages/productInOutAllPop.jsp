      ...
      <div class="x_content bs-example-popovers bg-white" id="popBody">
        ...
        <div class="row">
          <div class="cards-button">
            <button type="button" class="btn btn-primary btn-sm me-10" onClick="fnSaveAll()">저장</button>
            <button type="button" class="btn btn-danger btn-sm me-10" onClick="fnGridPopup('popupInOutAll','off')">닫기</button>
          </div>
        </div>
      </div>
    </div>
