...
<body class="nav-md">
  <div class="container body ps-10 pe-10">
    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
        <div class="cards" id="gridView">
          <div id="grid02" class="w-1005"></div>
          <hr/>
              ...
              <form class="form-horizontal">
                ...
                <div class="cards-button">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" onClick="fnSaveItems()">
                      출하 등록
                    </button>
                    <button type="button" class="btn btn-danger btn-sm" onClick="fnSavePlan()">
                      출하 계획 등록
                    </button>
                  </div>
                </div>
  ...
  <script src="${rsPath}/scripts/pages/shipping.js"></script>
</body>
