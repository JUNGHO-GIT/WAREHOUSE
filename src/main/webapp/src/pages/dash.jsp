...
<body class="theme-cyan">
  <div id="app" class="app">
    <div id="content" class="" style="margin: 1.3%">
      ...
      <div class="row" data-masonry='{"percentPosition":true}'>
        ...
        <!-- col 1 -->
        <div class=" col-lg-6 mb-4px" style="height: 21.5rem">
          <div class="card" style="height: 100%">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-xs-12 float-sm-start">
      ...
      <div class="row" data-masonry='{"percentPosition":true}'>
        <!-- col 1 -->
        <div class=" col-lg-3 mb-4px" style="height: 15rem">
          <div class="card" style="height: 100%">
            <div class="card-body">
              <div class="d-flex fw-bold small">
        ...
        <!-- col 3 -->
        <div class=" col-lg-6 mb-4px" style="height: 15rem">
          <div class="card" style="height: 100%">
            <div class="card-body">
      ...
      <div class="row" data-masonry='{"percentPosition":true}'>
        <!-- col 1 -->
        <div class=" col-lg-6 mb-4px" style="height: 20rem">
          <div class="card" style="height: 100%">
            <div class="card-body">
        ...
        <div class=" col-lg-6 mb-4px" style="height: 20rem">
          <div class="card" style="height: 100%">
            <div class="card-body">
              ...
              <hr class="hr" />
              <div class="col-xs-6 float-sm-start">
  ...
  <script src="${rsPath}/scripts/libs/pace.min.js"></script>
  <script src="${rsPath}/scripts/libs/dash.min.js"></script>
  <script src="${rsPath}/scripts/pages/dash.js"></script>
