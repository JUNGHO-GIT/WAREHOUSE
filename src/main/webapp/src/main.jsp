...
<body class="nav-md over-hidden">
      ...
      <div class="scroll-view">
        <div class="navbar nav_title">
          ...
          <c:if test="${empty fileUrl}">
            <img class="logo-image" src="/imgs/no-logo.webp" loading="eager" />
          </c:if>
          <c:if test="${not empty fileUrl}">
            <img class="logo-image" src="/viewFiles?fileUrl=${fileUrl}" loading="eager" />
          </c:if>
        </div>
        <br />
  ...
  <script src="/inc/js/page/main.js"></script>
