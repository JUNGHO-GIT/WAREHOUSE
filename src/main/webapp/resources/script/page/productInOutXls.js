...
function fnFilePicked(oEvent) {
  ...
  fileReader.onload = (e) => {
    ...
    wb.SheetNames.forEach((sheetName) => {
      ...
      const keyMap = [
        "prodNm", "inOutDt", "houseNm", "compNm", "qty", "unitPrice", "remarks", "inOutCheck"
      ];
...
function fnExDownload() {
  const fileUrl = "productInOut_Xls_sample.xls";
...
jQuery(function($) {
  fnShowExcel();
  const oFileIn = document.getElementById("productInOutXls");
