	...
	fn.remoteRequest = function(objP) {
		...
		if (typeof DM.getUrl == "function") {
			...
			if (typeof DM.url == "string") {
				url = DM.url;
				//var valParamString = {};
				var valParamString ={valParam1 : DM.varParam1,valParam2 : DM.varParam2};
				...
				}, filterQueryString, pageQueryString, sortQueryString, postData, postDataOnce,valParamString)
			}
		} if (!url) {
			return
		}
